...
python3 -m pyperformance run -r -o pyperfsys.json  # --debug-single-value -b nbody

pyenv global 3.7.9
python3 -m pip install --upgrade pip
python3 -m pip install --upgrade pyperformance || python3 -m pip install pyperformance
python3 -m pyperformance run -r -o pyperf30709.json  # --debug-single-value -b nbody

pyenv global 3.8.10
python3 -m pip install --upgrade pip
python3 -m pip install --upgrade pyperformance || python3 -m pip install pyperformance
python3 -m pyperformance run -r -o pyperf30810.json  # --debug-single-value -b nbody

pyenv global 3.9.12
python3 -m pip install --upgrade pip
python3 -m pip install --upgrade pyperformance || python3 -m pip install pyperformance
python3 -m pyperformance run -r -o pyperf30912.json  # --debug-single-value -b nbody

pyenv global 3.10.4
python3 -m pip install --upgrade pip
python3 -m pip install --upgrade pyperformance || python3 -m pip install pyperformance
python3 -m pyperformance run -r -o pyperf31004.json  # --debug-single-value -b nbody

pyenv global 3.11.0a6
python3 -m pip install --upgrade pip
python3 -m pip install --upgrade pyperformance || python3 -m pip install pyperformance
python3 -m pyperformance run -r -o pyperf311a6.json  # --debug-single-value -b nbody
